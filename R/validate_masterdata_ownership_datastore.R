#' Validate a `masterdata_ownership_datastore` object
#'
#' This function validates that an object is a valid `masterdata_ownership_datastore`
#' dataset.
#'
...
validate_masterdata_ownership_datastore <-
  function(data) {
